...
import { ChapterMark, DisplayTitle, BigNumber, Stamp, Hairline } from "@/components/sanad/type";

const stats = [
  { value: 2000000, suffix: "+", label: "unbanked SMEs in Tunisia", tone: "gold" as const },
...
export function Hero() {
  return (
    <section
      className="relative overflow-hidden px-6 pb-32 pt-24 sm:pt-32 lg:pt-40"
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 30% 30%, rgba(94,106,210,0.14), transparent 65%)" }}
      />
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <ChapterMark num="سند" label="Credit Passport Platform · Tunisia" tone="gold" />
        </motion.div>
        ...
        <div className="grid items-start gap-14 lg:grid-cols-[1fr_280px] lg:gap-20">
          ...
          <div>
            <motion.div
              ...
              className="mb-8"
            >
              <ArabicMark size={110} color="var(--linear-accent)" />
            </motion.div>
            ...
            <motion.p
              className="mt-8 mb-10 max-w-[52ch] text-lg leading-relaxed"
              style={{ color: "var(--muted-foreground)" }}
              initial={{ opacity: 0, y: 18 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.55, delay: 0.24, ease }}
            >
              Sanad speaks Darija, reads invoices, and delivers a signed Credit Passport in
            ...
            >
              <Button
                ...
                style={{
                  ...
                  color: "#fff",
                  boxShadow: "0 0 0 1px rgba(94,106,210,0.4), 0 4px 16px rgba(94,106,210,0.3)",
                }}
              >
                <Link href="/signup">
                  Get started
